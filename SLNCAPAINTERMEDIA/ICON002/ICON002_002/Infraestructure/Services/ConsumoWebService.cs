...
namespace ICON002_002.Infraestructure.Services
{
     ...
     
    {
        ...
        Task<T> GetWebService(string uri, string method, string urlRequest, int segundos, int intentos);
    }
    public class ConsumoWebService<T> : IConsumoWebService<T>
    {
        ...
        public async Task<T> PostWebService(string uri, string method, string jsonData, int segundos, int intentos)
        {
            ...
            try
            {
                ...
                Logger.FileLogger("APICON002002", "RESPONSE WS: Número de  intentos realizados : " + Convert.ToString(contador) + $", Tiempo Transcurrido : {diff} ms.");
        ...
        public async Task<T> GetWebService(string uri, string method, string urlRequest, int segundos, int intentos)
        {
            try
            {
                T resultadoApi = default(T);
