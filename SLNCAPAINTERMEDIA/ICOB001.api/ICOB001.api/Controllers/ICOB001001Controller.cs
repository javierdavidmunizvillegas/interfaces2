    ...
    public class ICOB001001Controller : ControllerBase
    {
        ...
        public async Task<ActionResult<APICOB001001MessageResponse>> APICOB001001(APICOB001001MessageRequest parametrorequest)
        {
            ...
            try
            {
                ...
                string nombre_metodo = "APICOB001001";

                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APICOB001001", "CONTROLADOR: Request Recibido: " + jsonrequest);
                ...
                {
                    respuesta = new APICOB001001MessageResponse();
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("ICOB001:E000|SERVICIO DE HOMOLOGACIÓN NO DISPONIBLE");

                    Logger.FileLogger("APICOB001001", "CONTROLADOR WS HOMOLOGACION: No se retorno resultado de Homologación");
                ...
                {
                    parametrorequest.CustAccount = CodigoCliente.CrecosAdynamics(parametrorequest.CustAccount, longAllenar, "APICOB001001");
                }

                string jsonrequest2 = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APICOB001001", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
                ...
                if (respuesta == null)
                {
                    ...
                    respuesta.ErrorList.Add("ICOB001:E000|NO SE RETORNO RESULTADO DE DYNAMICS");
                    Logger.FileLogger("APICOB001001", "CONTROLADOR: No se retorno resultado de Dynamics");
                    return Ok(respuesta);

                }

                string jsonrequest3 = JsonConvert.SerializeObject(respuesta);
                Logger.FileLogger("APICOB001001", "CONTROLADOR: Response desde Dynamics: " + jsonrequest3);
            ...
            catch (Exception ex)
            {
                ...
                respuesta.ErrorList.Add("ICOB001:E000|NO SE RETORNO RESULTADOS DE DYNAMICS");
              
                Logger.FileLogger("APICOB001001", "CONTROLADOR: ERROR: " + ex.ToString());
                return Ok(respuesta);
