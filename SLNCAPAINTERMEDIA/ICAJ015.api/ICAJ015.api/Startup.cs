...
namespace ICAJ015.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IManejadorRequest<APICAJ015001MessageRequest>), typeof(ManejadorRequest<APICAJ015001MessageRequest>));
            services.AddScoped(typeof(IManejadorResponse<APICAJ015001MessageResponse>), typeof(ManejadorResponse<APICAJ015001MessageResponse>));
            ...
            {
                Title = "Interfaz Documento ICAJ015",
                Description = "Creación, Activación, y Bloqueo de Productos Financieros de Tarjetas de Crédito",
                Version = "v1"
            });
            });
        }
