...
namespace ICAJ004.api.Infraestructure.Configuration
{
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (!modelState.IsValid)
            {
                ...
                if (errors != null)
                {
                    ...
                    respuesta.ledgerJournalCashDepositsResponseList = new List<APLedgerJournalCashDepositsResponse>();
                ...
                Logger.FileLogger("APICAJ004001", "VALIDADOR REQUEST: " + result);
