...
namespace IVTA009.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IManejadorRequest<APIVTA009001MessageRequest>), typeof(ManejadorRequest<APIVTA009001MessageRequest>));
            services.AddScoped(typeof(IManejadorResponse<APIVTA009001MessageResponse>), typeof(ManejadorResponse<APIVTA009001MessageResponse>));
            ...
            {
                Title = "Interfaz Documento IVTA009",
                Description = "Interfaz SBO a MSD365FO, actualizar la versión de costo de productos MKP",
                Version = "v1"
            });
            });
        }
