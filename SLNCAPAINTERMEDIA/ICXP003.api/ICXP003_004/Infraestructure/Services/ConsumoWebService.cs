...
namespace ICXP003_004.Infraestructura.Servicios
{
    ...
    public class ConsumoWebService<T> : IConsumoWebService<T>
    {
        ...
        public async Task<T> PostWebService(string uri, string method, string jsonData, int segundos, int intentos)
        {
            ...
            try
            {
                ...
                Logger.FileLogger("APICXP003004", "WS FUNCION: Número de  intentos realizados : " + Convert.ToString(contador) + $", Tiempo Transcurrido : {diff} ms.");
