...
{    
    ...
    public class ICXP003002Controller : ControllerBase
    {
        ...
        public async Task<ActionResult<APICXP003002MessageResponse>> APICXP003002(APICXP003002MessageRequest parametrorequest)
        {
            ...
            try
            {
                string nombre_metodo = "APICXP003002";

                
                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APICXP003002", "CONTROLADOR: Request Recibido: " + jsonrequest);
                ...
                {
                    respuesta = new APICXP003002MessageResponse();
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("ICXP003:E000|SERVICIO DE HOMOLOGACIÓN NO DISPONIBLE");

                    Logger.FileLogger("APICXP003002", "CONTROLADOR WS HOMOLOGACION: No se retorno resultado de Homologación");
                ...
                Logger.FileLogger("APICXP003002", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
                ...
                if (respuesta == null)
                {
                    ...
                    Logger.FileLogger("APICXP003002", "CONTROLADOR: No se retorno resultado de Dynamics");
                    return Ok(respuesta);

                }

                string jsonrequest3 = JsonConvert.SerializeObject(respuesta);
                Logger.FileLogger("APICXP003002", "CONTROLADOR: Response desde Dynamics: " + jsonrequest3);
            ...
            catch (Exception ex)
            {
                ...
                Logger.FileLogger("APICXP003002", "CONTROLADOR: ERROR: " + ex.ToString());
                return Ok(respuesta);
