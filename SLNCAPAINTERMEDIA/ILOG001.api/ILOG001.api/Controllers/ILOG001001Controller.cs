...
using ILOG001.api.Models._001.Request;
...
{
    [ApiController]
    public class ILOG001001Controller : ControllerBase
    {
        private IManejadorRequest<APILOG001001MessageRequest> QueueRequest;
        ...
        private static ConvierteCodigo CodigoNotes = new ConvierteCodigo();

        public ILOG001001Controller(IManejadorRequest<APILOG001001MessageRequest> _manejadorRequest,
        ...
        [HttpPost]
        [Route("APILOG001001")]
        public async Task APILOG001001(WeHooksListD[] parametrorequest)
        {
            try
            {
                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APILOG001001", "CONTROLADOR: Request Recibido: " + jsonrequest);

                APILOG001001MessageRequest request = new APILOG001001MessageRequest();
                List<WeHooksList> lista = new List<WeHooksList>();

                WeHooksList WH = new WeHooksList();
                ...
                Logger.FileLogger("APILOG001001", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
            ...
            catch (Exception ex)
            {
                ...
                Logger.FileLogger("APILOG001001", "CONTROLADOR: ERROR: " + ex.ToString());
