    ...
    public class IPRO012002Controller : ControllerBase
    {
        ...
        public async Task<ActionResult<APIPRO012002MessageResponse>> APIPRO012002(APIPRO012002MessageRequest parametrorequest)
        {
            ...
            try
            {
                ...
                string nombre_metodo = "APIPRO012002";

                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APIPRO012002", "CONTROLADOR: Request Recibido: " + jsonrequest);
                ...
                {
                    respuesta = new APIPRO012002MessageResponse();
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("IPRO012:E000|SERVICIO DE HOMOLOGACIÓN NO DISPONIBLE");

                    Logger.FileLogger("APIPRO012002", "CONTROLADOR WS HOMOLOGACION: No se retorno resultado de Homologación");
                ...
                Logger.FileLogger("APIPRO012002", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
                ...
                if (respuesta == null)
                {
                    ...
                    Logger.FileLogger("APIPRO012002", "CONTROLADOR: No se retorno resultado de Dynamics");
                    return Ok(respuesta);
            ...
            catch (Exception ex)
            {
                ...
                Logger.FileLogger("APIPRO012002", "CONTROLADOR: ERROR: " + ex.ToString());
                return Ok(respuesta);
