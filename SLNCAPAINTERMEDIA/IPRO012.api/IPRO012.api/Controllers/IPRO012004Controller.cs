    ...
    public class IPRO012004Controller : ControllerBase
    {
        ...
        public async Task<ActionResult<APIPRO012004MessageResponse>> APIPRO012004(APIPRO012004MessageRequest parametrorequest)
        {
            ...
            try
            {
                ...
                string nombre_metodo = "APIPRO012004";

                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APIPRO012004", "CONTROLADOR: Request Recibido: " + jsonrequest);
                ...
                {
                    respuesta = new APIPRO012004MessageResponse();
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("IPRO012:E000|SERVICIO DE HOMOLOGACIÓN NO DISPONIBLE");

                    Logger.FileLogger("APIPRO012004", "CONTROLADOR WS HOMOLOGACION: No se retorno resultado de Homologación");
                ...
                Logger.FileLogger("APIPRO012004", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
                ...
                if (respuesta == null)
                {
                    ...
                    Logger.FileLogger("APIPRO012004", "CONTROLADOR: No se retorno resultado de Dynamics");
                    return Ok(respuesta);

                }

                string jsonrequest3 = JsonConvert.SerializeObject(respuesta);
                Logger.FileLogger("APIPRO012004", "CONTROLADOR: Response desde Dynamics: " + jsonrequest3);
            ...
            catch (Exception ex)
            {
                ...
                Logger.FileLogger("APIPRO012004", "CONTROLADOR: ERROR: " + ex.ToString());
                return Ok(respuesta);
