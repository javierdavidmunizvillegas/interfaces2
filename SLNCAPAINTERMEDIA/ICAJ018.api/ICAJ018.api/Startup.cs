...
namespace ICAJ018.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IManejadorRequest<APICAJ018001MessageRequest>), typeof(ManejadorRequest<APICAJ018001MessageRequest>));
            services.AddScoped(typeof(IManejadorResponse<APICAJ018001MessageResponse>), typeof(ManejadorResponse<APICAJ018001MessageResponse>));
            ...
            {
                Title = "Interfaz Documento ICAJ018",
                Description = "Interfaz para la consulta de los depósito reparados y confirmados",
                Version = "v1"
            });
            });
        }
