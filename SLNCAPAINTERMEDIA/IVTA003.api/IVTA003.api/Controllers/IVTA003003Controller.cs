...
namespace IVTA003.api.Controllers
{
    ...
    [ApiController]
    public class IVTA003003Controller : ControllerBase
    {
        private IManejadorRequest<APIVTA003003MessageRequest> QueueRequest;
        private IManejadorResponse<APIVTA003003MessageResponse> QueueResponse;
        ...
        public IVTA003003Controller(IManejadorRequest<APIVTA003003MessageRequest> _manejadorRequest
            , IManejadorResponse<APIVTA003003MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIVTA003003MessageResponse>> APIVTA003003(APIVTA003003MessageRequest parametrorequest)
        {
            APIVTA003003MessageResponse respuesta = null;
            try
            {

                string nombre_metodo = "APIVTA003003";

                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APIVTA003003", "CONTROLADOR: Request Recibido: " + jsonrequest);
                ...
                {
                    respuesta = new APIVTA003003MessageResponse();
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("IVTA003:E000|SERVICIO DE HOMOLOGACIÓN NO DISPONIBLE");

                    Logger.FileLogger("APIVTA003003", "CONTROLADOR WS HOMOLOGACION: No se retorno resultado de Homologación");
                ...
                Logger.FileLogger("APIVTA003003", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
                ...
                if (respuesta == null)
                {
                    ...
                    Logger.FileLogger("APIVTA003003", "CONTROLADOR: No se retorno resultado de Dynamics");
                    return Ok(respuesta);

                }

                string jsonrequest3 = JsonConvert.SerializeObject(respuesta);
                Logger.FileLogger("APIVTA003003", "CONTROLADOR: Response desde Dynamics: " + jsonrequest3);
            ...
            catch (Exception ex)
            {
                ...
                Logger.FileLogger("APIVTA003003", "CONTROLADOR: ERROR: " + ex.ToString());
                return Ok(respuesta);
