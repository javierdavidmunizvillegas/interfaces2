...
namespace IVTA019.api.Controllers
{
    
    [ApiController]
    public class IVTA019001Controller : ControllerBase
    {
        private IManejadorRequest<APIVTA019001MessageRequest> QueueRequest;
        private IManejadorResponse<APIVTA019001MessageResponse> QueueResponse;
        ...
        public IVTA019001Controller(IManejadorRequest<APIVTA019001MessageRequest> _manejadorRequest
             , IManejadorResponse<APIVTA019001MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIVTA019001MessageResponse>> APIVTA019001(APIVTA019001MessageRequest parametrorequest)
        {
            APIVTA019001MessageResponse respuesta = null;
            try
            {

                string nombre_metodo = "APIVTA019001";

                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APIVTA019001", "CONTROLADOR: Request Recibido: " + jsonrequest);
                ...
                {
                    respuesta = new APIVTA019001MessageResponse();
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("IVTA019:E000|SERVICIO DE HOMOLOGACIÓN NO DISPONIBLE");

                    Logger.FileLogger("APIVTA019001", "CONTROLADOR WS HOMOLOGACION: No se retorno resultado de Homologación");
                ...
                {
                    parametrorequest.CustAccount = CodigoCliente.CrecosAdynamics(parametrorequest.CustAccount, longAllenar, "APIVTA019001");

                }

                string jsonrequest2 = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APIVTA019001", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
                ...
                if (respuesta == null)
                {
                    ...
                    respuesta.ErrorList.Add("IVTA019:E000|NO SE RETORNO RESULTADO DE DYNAMICS");
                    Logger.FileLogger("APIVTA019001", "CONTROLADOR: No se retorno resultado de Dynamics");
                    return Ok(respuesta);

                }

                string jsonrequest3 = JsonConvert.SerializeObject(respuesta);
                Logger.FileLogger("APIVTA019001", "CONTROLADOR: Response desde Dynamics: " + jsonrequest3);
            ...
            catch (Exception ex)
            {
                ...
                respuesta.ErrorList.Add("IVTA019:E000|NO SE RETORNO RESULTADOS DE DYNAMICS");

                Logger.FileLogger("APIVTA019001", "CONTROLADOR: ERROR: " + ex.ToString());
                return Ok(respuesta);
