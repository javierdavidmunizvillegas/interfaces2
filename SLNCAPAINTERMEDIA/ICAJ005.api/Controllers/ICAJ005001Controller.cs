...
namespace ICAJ005.api.Controllers
{
    
    [ApiController]
    public class ICAJ005001Controller : ControllerBase
    {
        private IManejadorRequest<APICAJ005001MessageRequest> manejadorRequestQueue;
        private IManejadorResponse<APICAJ005001MessageResponse> manejadorReponseQueue;
        ...
        public ICAJ005001Controller(IManejadorRequest<APICAJ005001MessageRequest> _manejadorRequest
             , IManejadorResponse<APICAJ005001MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APICAJ005001MessageResponse>> APICAJ005001(APICAJ005001MessageRequest parametrorequest)
        {
            string nombre_metodo = "APICAJ005001";
            ...
            try
            {
                ...
                for (int i = 1; i < vl_IntentosWS; i++)
                {
                    try
                    {
                        ...
                        if (ResuldatoHomologa != null && (string.IsNullOrEmpty(ResuldatoHomologa.Response) || string.IsNullOrWhiteSpace(ResuldatoHomologa.Response)))
                        {
                            ...
                            respuesta.ErrorList.Add("ICAJ005:E000|EMPRESA NO EXISTE");
                ...
                if (ResuldatoHomologa == null)
                {
                    ...
                    respuesta.StatusId = false;
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("ICAJ005:E000|SERVICIO DE HOMOLOGACION NO DISPONIBLE");
                    return Ok(respuesta); // StatusCode(StatusCodes.Status204NoContent, respuesta);
                }
                ...
                if (respuesta == null)
                {
                    ...
                    respuesta.StatusId = false;
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("ICAJ005:E000|NO SE RETORNO RESULTADO DE DYNAMICS");
            ...
            catch (Exception ex)
            {
                ...
                respuesta.StatusId = false;
                respuesta.ErrorList = new List<string>();
                respuesta.ErrorList.Add("ICAJ005:E000|NO SE RETORNO RESULTADO DE DYNAMICS"); //ex.Message
                Logger.FileLogger(nombre_metodo, "CONTROLADOR: Request Enviado a Dynamics: " + respuestaLog);
