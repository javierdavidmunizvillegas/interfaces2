    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            new Microsoft.OpenApi.Models.OpenApiInfo
            {
                ...
                Description = "Interfaz para la confirmación de depósito de valores se realiza una vez que se entrega el depósito de valores al banco (Blindado o ventanilla), y se confirma en el sistema luego haberse recibido el depósito",
                Version = "v1"
            });
            });
        }
