    ...
    public class ICRE001001Controller : ControllerBase
    {
        ...
        public async Task<ActionResult<APICRE001001MessageResponse>> APICRE001001(APICRE001001MessageRequest parametrorequest)
        {
            ...
            try
            {
                ...
                string nombre_metodo = "APICRE001001";

                string jsonrequest = JsonConvert.SerializeObject(parametrorequest);
                Logger.FileLogger("APICRE001001", "CONTROLADOR: Request Recibido: " + jsonrequest);
                ...
                {
                    respuesta = new APICRE001001MessageResponse();
                    respuesta.ErrorList = new List<string>();
                    respuesta.ErrorList.Add("ICRE001:E000|SERVICIO DE HOMOLOGACIÓN NO DISPONIBLE");

                    Logger.FileLogger("APICRE001001", "CONTROLADOR WS HOMOLOGACION: No se retorno resultado de Homologación");
                ...
                Logger.FileLogger("APICRE001001", "CONTROLADOR: Request Enviado a Dynamics: " + jsonrequest2);
                ...
                if (respuesta == null)
                {
                    ...
                    Logger.FileLogger("APICRE001001", "CONTROLADOR: No se retorno resultado de Dynamics");
                    return Ok(respuesta);
                }
                else
                {
                    ...
                    {
                        respuesta.APCustTable.AccountNum = Int32.Parse(CodigoCliente.DynamicAcrecos(respuesta.APCustTable.AccountNum, "APICRE001001")).ToString();
                       
                        if (respuesta.APCustTable.APIndependetEntrep != null)
                        {
                            respuesta.APCustTable.APIndependetEntrep.AccountNum = Int32.Parse(CodigoCliente.DynamicAcrecos(respuesta.APCustTable.APIndependetEntrep.AccountNum, "APICRE001001")).ToString();
                ...
                Logger.FileLogger("APICRE001001", "CONTROLADOR: Response desde Dynamics: " + jsonrequest3);
            ...
            catch (Exception ex)
            {
                ...
                respuesta.ErrorList.Add("ICRE001:E000|NO SE RETORNO RESULTADOS DE DYNAMICS");
                Logger.FileLogger("APICRE001001", "CONTROLADOR: ERROR: " + ex.ToString());
                return Ok(respuesta);
