...
namespace ILOG002_004.Infraestructure.Services
{
     ...
     
    {
        ...
        Task<T> PutWebService(string uri, string method, string jsonData, int segundos, int intentos, string token, string vl_varAutorizacion, string vl_valAutorizacion, string vl_valToken);
    ...
    public class ConsumoWebService<T> : IConsumoWebService<T>
    {
        ...
        public async Task<T> PostWebService(string uri, string method, string jsonData, int segundos, int intentos, string vl_varAutorizacion, string vl_valAutorizacion)
        {
            ...
            try
            {
                ...
                Logger.FileLogger("APILOG002004", "RESPONSE WS: Número de  intentos realizados : " + Convert.ToString(contador) + $", Tiempo Transcurrido : {diff} ms.");
        ...
        public async Task<T> PutWebService(string uri, string method, string jsonData, int segundos, int intentos, string token, string vl_varAutorizacion, string vl_valAutorizacion, string vl_valToken)
        {
            ...
            try
            {
                ...
                var request = new RestRequest(method, Method.PUT, DataFormat.Json);
