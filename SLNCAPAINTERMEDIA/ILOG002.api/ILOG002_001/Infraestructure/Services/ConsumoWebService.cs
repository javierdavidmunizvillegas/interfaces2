            ...
            try
            {
                ...
                while (contador < intentos)
                {
                    ...
                    else
                    {
                        var content = response.Content;
                        resultadoApi = JsonConvert.DeserializeObject<T>(content);
                        Logger.FileLogger("APILOG002001", "RESPONSE WS: Error encontrado: " + resultadoApi);
                ...
                Logger.FileLogger("APILOG002001", "RESPONSE WS: Número de  intentos realizados : " + Convert.ToString(contador) + $", Tiempo Transcurrido : {diff} ms.");
