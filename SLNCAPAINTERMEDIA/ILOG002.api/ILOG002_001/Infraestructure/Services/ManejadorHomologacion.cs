...
namespace ILOG002_001.Infraestructure.Services
{
    ...
    public class ManejadorHomologacion<T> : IManejadorHomologacion<T>
    {
        ...
        public async Task<T> GetHomologacion(string uri, string method, string urlRequest, int segundos, int intentos)
        {
            try
            {
                ...
                Logger.FileLogger("APILOG002001", "WS HOMOLOGACIÓN : Número de  intentos realizados : " + Convert.ToString(contador) + $", Tiempo Transcurrido : {diff} ms.");
