...
{
    public class ValidadorRequest05 : Microsoft.AspNetCore.Mvc.Filters.ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (!modelState.IsValid)
            {
                ...
                if (errors != null)
                {
                    ...
                    respuesta.APTransfersSearchContractList = new List<APTransfersSearchContract>();
                ...
                Logger.FileLogger("APIPRO005005", "VALIDADOR REQUEST: " + result);
