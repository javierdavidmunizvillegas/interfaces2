...
{
    public class ValidadorRequest07 : Microsoft.AspNetCore.Mvc.Filters.ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (!modelState.IsValid)
            {
                ...
                if (errors != null)
                {
                    ...
                    respuesta.APDistributionCentersContractList = new List<APDistributionCentersContract>();
                ...
                Logger.FileLogger("APIPRO005007", "VALIDADOR REQUEST: " + result);
