...
{
    public class ValidadorRequest06 : Microsoft.AspNetCore.Mvc.Filters.ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (!modelState.IsValid)
            {
                ...
                if (errors != null)
                {
                    ...
                    respuesta.APMovementSearchContractList = new List<APMovementSearchContract>();
                ...
                Logger.FileLogger("APIPRO005006", "VALIDADOR REQUEST: " + result);
