...
namespace IPRO005.api.Controllers
{
    ...
    [ApiController]
    public class IPRO005005Controller : ControllerBase
    {
        private IManejadorRequest<APIPRO005005MessageRequest> QueueRequest;
        private IManejadorResponse<APIPRO005005MessageResponse> QueueResponse;
        ...
        public IPRO005005Controller(IManejadorRequest<APIPRO005005MessageRequest> _manejadorRequest
            , IManejadorResponse<APIPRO005005MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        [HttpPost]
        [Route("APIPRO005005")]
        [ServiceFilter(typeof(ValidadorRequest05))]
        public async Task<ActionResult<APIPRO005005MessageResponse>> APIPRO005005(APIPRO005005MessageRequest parametrorequest)
        {
            long start = 0, end = 0;
            double diff = 0;
            string responseHomologa = string.Empty;
            APIPRO005005MessageResponse respuesta = null;
            ResponseHomologacion ResuldatoHomologa = null;
            string nombre_metodo = "APIPRO005005";
            try
            {
                ...
                for (int i = 1; i < vl_Attemptsws; i++)
                {
                    try
                    {
                        ...
                        {
                            respuesta = new APIPRO005005MessageResponse();
