...
namespace IPRO005.api.Controllers
{
    ...
    [ApiController]
    public class IPRO005007Controller : ControllerBase
    {
        private IManejadorRequest<APIPRO005007MessageRequest> QueueRequest;
        private IManejadorResponse<APIPRO005007MessageResponse> QueueResponse;
        ...
        public IPRO005007Controller(IManejadorRequest<APIPRO005007MessageRequest> _manejadorRequest
            , IManejadorResponse<APIPRO005007MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        [HttpPost]
        [Route("APIPRO005007")]
        [ServiceFilter(typeof(ValidadorRequest07))]
        public async Task<ActionResult<APIPRO005007MessageResponse>> APIPRO005007(APIPRO005007MessageRequest parametrorequest)
        {
            long start = 0, end = 0;
            double diff = 0;
            string responseHomologa = string.Empty;
            APIPRO005007MessageResponse respuesta = null;
            ResponseHomologacion ResuldatoHomologa = null;
            string nombre_metodo = "APIPRO005007";
            try
            {
                ...
                for (int i = 1; i < vl_Attemptsws; i++)
                {
                    try
                    {
                        ...
                        {
                            respuesta = new APIPRO005007MessageResponse();
