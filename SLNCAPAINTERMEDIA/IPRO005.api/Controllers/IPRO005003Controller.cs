...
namespace IPRO005.api.Controllers
{
    ...
    [ApiController]
    public class IPRO005003Controller : ControllerBase
    {
        private IManejadorRequest<APIPRO005003MessageRequest> QueueRequest;
        private IManejadorResponse<APIPRO005003MessageResponse> QueueResponse;
        ...
        public IPRO005003Controller(IManejadorRequest<APIPRO005003MessageRequest> _manejadorRequest
            , IManejadorResponse<APIPRO005003MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        [HttpPost]
        [Route("APIPRO005003")]
        [ServiceFilter(typeof(ValidadorRequest03))]
        public async Task<ActionResult<APIPRO005003MessageResponse>> APIPRO005003(APIPRO005003MessageRequest parametrorequest)
        {
            long start = 0, end = 0;
            double diff = 0;
            ...
            string nombre_metodo = " APIPRO005003";
            try
            {
