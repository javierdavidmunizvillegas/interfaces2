...
namespace IPRO005.api.Controllers
{
    ...
    [ApiController]
    public class IPRO005002Controller : ControllerBase
    {
        private IManejadorRequest<APIPRO005002MessageRequest> QueueRequest;
        private IManejadorResponse<APIPRO005002MessageResponse> QueueResponse;
        ...
        public IPRO005002Controller(IManejadorRequest<APIPRO005002MessageRequest> _manejadorRequest
            , IManejadorResponse<APIPRO005002MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        [HttpPost]
        [Route("APIPRO005002")]
        [ServiceFilter(typeof(ValidadorRequest02))]
        public async Task<ActionResult<APIPRO005002MessageResponse>> APIPRO005002(APIPRO005002MessageRequest parametrorequest)
        {
            long start = 0, end = 0;
            double diff = 0;
            ...
            string nombre_metodo = "APIPRO005002";
            try
            {
