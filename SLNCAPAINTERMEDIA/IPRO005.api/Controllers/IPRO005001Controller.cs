...
namespace IPRO005.api.Controllers
{
    ...
    public class IPRO005001Controller : ControllerBase
    {
        ...
        public IPRO005001Controller(IManejadorRequest<APIPRO005001MessageRequest> _manejadorRequest
            , IManejadorResponse<APIPRO005001MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        [HttpPost]
        [Route("APIPRO005001")]
        [ServiceFilter(typeof(ValidadorRequest01))]
        public async Task<ActionResult<APIPRO005001MessageResponse>> APIPRO005001(APIPRO005001MessageRequest parametrorequest)
        {
            ...
            string nombre_metodo = "APIPRO005001";
            try
            {
