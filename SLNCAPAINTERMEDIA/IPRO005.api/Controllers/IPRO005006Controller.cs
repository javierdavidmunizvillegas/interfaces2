...
namespace IPRO005.api.Controllers
{
    ...
    [ApiController]
    public class IPRO005006Controller : ControllerBase
    {
        private IManejadorRequest<APIPRO005006MessageRequest> QueueRequest;
        private IManejadorResponse<APIPRO005006MessageResponse> QueueResponse;
        ...
        public IPRO005006Controller(IManejadorRequest<APIPRO005006MessageRequest> _manejadorRequest
            , IManejadorResponse<APIPRO005006MessageResponse> _manejadorReponse, IManejadorHomologacion<ResponseHomologacion> _homologacionRequest)
        {
        ...
        [HttpPost]
        [Route("APIPRO005006")]
        [ServiceFilter(typeof(ValidadorRequest06))]
        public async Task<ActionResult<APIPRO005006MessageResponse>> APIPRO005006(APIPRO005006MessageRequest parametrorequest)
        {
            long start = 0, end = 0;
            double diff = 0;
            string responseHomologa = string.Empty;
            APIPRO005006MessageResponse respuesta = null;
            ResponseHomologacion ResuldatoHomologa = null;
            string nombre_metodo = "APIPRO005006";
            try
            {
                ...
                for (int i = 1; i < vl_Attemptsws; i++)
                {
                    try
                    {
                        ...
                        {
                            respuesta = new APIPRO005006MessageResponse();
