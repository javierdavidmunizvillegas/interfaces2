...
namespace IVTA006.Infraestructure.Services
{
    ...
    public class ManejadorHomologacion<T> : IManejadorHomologacion<T>
    {
        ...
        public async Task<T> GetHomologacion(string uri, string method, string urlRequest, int segundos, int intentos)
        {
            try
            {
                ...
                Logger.FileLogger("APIVTA006001", "WS HOMOLOGACIÓN : Número de  intentos realizados : " + Convert.ToString(contador) + $", Tiempo Transcurrido : {diff} ms.");
