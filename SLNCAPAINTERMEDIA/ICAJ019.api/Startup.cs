    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "ICAJ019.api",
                    Description = "Exponer Relación movimientos de origen y su reverso (facturas, recaudos, ingresos y egresos de caja",
                    Version = "v1"
                });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                options.SwaggerEndpoint("../swagger/v1/swagger.json", "Devoluciones, Dación, Reversos de cobros, Aplicación de documentos");
