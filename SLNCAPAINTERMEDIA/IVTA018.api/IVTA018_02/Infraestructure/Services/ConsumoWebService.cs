...
namespace IVTA018_02.Infraestructure.Services
{
    ...
    public class ConsumoWebService<T> : IConsumoWebService<T>
    {
        ...
        public async Task<T> PostWebService(string uri, string method, string jsonData, int segundos, int intentos)
        {
            ...
            try
            {
                ...
                Logger.FileLogger("APIVTA018002F", "RESPONSE WS: Número de  intentos realizados : " + Convert.ToString(contador) + $", Tiempo Transcurrido : {diff} ms.");
