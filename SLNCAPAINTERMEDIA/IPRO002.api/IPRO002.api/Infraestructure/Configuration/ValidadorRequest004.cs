...
namespace IPRO002.api.Infraestructure.Configuration
{
    public class ValidadorRequest004: Microsoft.AspNetCore.Mvc.Filters.ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (!modelState.IsValid)
            {
                ...
                Logger.FileLogger("APISAC020004", "VALIDADOR REQUEST: " + result);
